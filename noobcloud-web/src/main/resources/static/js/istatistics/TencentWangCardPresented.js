...
var TencentWangCardPresented = function () {
    var dataTable = {}, obj = {}, queryB2iSmartFromsDaily = "queryPushBtoiSenceDetailByB2i_Type.view", queryB2iSmartFromsMonthly = "queryPushBtoiScenceStaticMonthByB2i_Type.view",
        downLoadB2iSmartFromsUrl = "downloadB2iSmartCloudFormData.view",b2iType = 4;
...
function loadTencentWangCardPresented(type) {
    TencentWangCardPresented.initQueryData();

    if (type == 1) // 日报
    {
        TencentWangCardPresented.dailyDataTableInit(1);
    }
    else if (type == 2) // 月报
    {
        TencentWangCardPresented.monthlyDataTableInit(2);
    }
    TencentWangCardPresented.initEvent(type);
}
