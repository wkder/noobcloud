...
var maYiDaBaoPackageUpgrade = function () {
    var dataTable = {}, obj = {}, queryB2iSmartFromsDaily = "queryPushBtoiSenceDetailByB2i_Type.view", queryB2iSmartFromsMonthly = "queryPushBtoiScenceStaticMonthByB2i_Type.view",
        downLoadB2iSmartFromsUrl = "downloadB2iSmartCloudFormData.view",b2iType = 3;
...
// 加载余额不足提醒
function loadMaYiDaBaoPackageUpgrade(type) {
    maYiDaBaoPackageUpgrade.initQueryData();

    if (type == 1) // 日报
    {
        maYiDaBaoPackageUpgrade.dailyDataTableInit(1);
    }
    else if (type == 2) // 月报
    {
        maYiDaBaoPackageUpgrade.monthlyDataTableInit(2);
    }
    maYiDaBaoPackageUpgrade.initEvent(type);
}
