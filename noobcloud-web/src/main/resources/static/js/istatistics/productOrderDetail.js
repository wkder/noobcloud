...
var productOrderDetail = function () {
    var obj = {},
        dataTable,
        secondRowObj = {},
    ...
    obj.initDataTable = function(){
        var option = {
            ...
            ordering: true,
            columns: [
                {data: "productname", title: "产品名称", width: 100 ,className:"dataTableFirstColumns", orderable: true},
                {data: "productcode", title: "产品编码", width: 80, orderable: false},
                {data: "productprice", title: "资费", width: 30, orderable: true},
                {data: "ordernum", title: "订购次数", width: 40, orderable: true},
                {data: "succnum", title: "成功次数", width: 40, orderable: true},
                {data: "orderuser", title: "订购用户数", width: 50},
                {data: "succuser", title: "成功用户数", width: 50},
                {data: "succrate", title: "成功率", width: 40, orderable: false},
                {data: "totalprice", title: "总&nbsp;&nbsp;额", width: 30},
                {data: "factoryname", title: "营销厂家", width: 40},
                {data: "channel", title: "订购渠道", width: 40},
                {title: "操作", width: 50, orderable: false,
...
function onLoadBody(){
    ...
    productOrderDetail.initDataTable();
