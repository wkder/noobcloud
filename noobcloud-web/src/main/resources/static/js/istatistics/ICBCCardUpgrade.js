...
var ICBCCardUpgrade = function () {
    var dataTable = {}, obj = {}, queryB2iSmartFromsDaily = "queryPushBtoiSenceDetailByB2i_Type.view", queryB2iSmartFromsMonthly = "queryPushBtoiScenceStaticMonthByB2i_Type.view",
        downLoadB2iSmartFromsUrl = "downloadB2iSmartCloudFormData.view",b2iType = 6;
...
function loadICBCCardUpgrade(type) {
    ICBCCardUpgrade.initQueryData();

    if (type == 1) // 日报
    {
        ICBCCardUpgrade.dailyDataTableInit(1);
    }
    else if (type == 2) // 月报
    {
        ICBCCardUpgrade.monthlyDataTableInit(2);
    }
    ICBCCardUpgrade.initEvent(type);
}
