...
var wangCardAssistant = function () {
    var dataTable = {}, obj = {}, queryB2iSmartFromsDaily = "queryPushBtoiSenceDetailByB2i_Type.view", queryB2iSmartFromsMonthly = "queryPushBtoiScenceStaticMonthByB2i_Type.view",
        downLoadB2iSmartFromsUrl = "downloadB2iSmartCloudFormData.view",b2iType = 2;
    ...
    obj.dailyDataTableInit = function (type) {
        var option = {
            ...
            columns: [
                ...
                {data: "sale_name", width: 600, title: "绑定状态", className: "centerColumns",render: function (data, type, row, meta) {
                    console.log(data);
                    if(data == "1")
                    {
                        return "已绑定";
    ...
    obj.monthlyDataTableInit = function (type) {
        var option = {
            ...
            columns: [
                ...
                {width: 600, title: "绑定状态", className: "centerColumns",render: function (data, type, row, meta) {
                    return "已绑定";
                }}
            ]
        };
...
// 加载余额不足提醒
function loadWangCardAssistant(type) {
    wangCardAssistant.initQueryData();

    if (type == 1) // 日报
    {
        wangCardAssistant.dailyDataTableInit(1);
    }
    else if (type == 2) // 月报
    {
        wangCardAssistant.monthlyDataTableInit(2);
    }
    wangCardAssistant.initEvent(type);
}
