...
var shopDaily = function () {
    ...
    obj.dataTableInit = function () {
        var params = "dateTime=" + $("#txtQueryDate").val() + "&areaCode=" + $("#selectQueryBaseAreas").val() + "&locationType=" + $("#selectQueryLocationType").val() + "&bussHallCoding=" + $.trim($("#bussHallCoding").val()) + "&baseId=" + $("#selectQueryBase").val();
        var option = {
            ele: $('#dataTable'),
            ajax: {
                url: getUrl + "?" + params,
            ...
            drawCallback: function (settings, json) {
                ...
                globalRequest.iShop.queryShopDailyTotal(false, params, function (data) {
                    ...
                    //  黄埔厅合计
                    if (hpTotal) {
                        var hpTotalTdHtml = "<td></td><td></td><td></td><td></td><td>" + hpTotal.provincetasknumtotal + "</td><td>" + hpTotal.citytasknumtotal + "</td><td>" + hpTotal.basetasknumtotal + "</td><td>" + hpTotal.executetasknumtotal + "</td><td>" + hpTotal.executetasktotalrate + "</td><td>" + hpTotal.businesstypenumtotal + "</td><td>" + hpTotal.basecoverusertotal + "</td><td>" + hpTotal.residenttotalrate + "</td><td>" + hpTotal.sendusertotalnum + "</td><td>" + hpTotal.smstotalrate + "</td>";
                    ...
                    //  自营厅合计
                    if (zyTotal) {
                        var zyTotalTdHtml = "<td></td><td></td><td></td><td></td><td>" + zyTotal.provincetasknumtotal + "</td><td>" + zyTotal.citytasknumtotal + "</td><td>" + zyTotal.basetasknumtotal + "</td><td>" + zyTotal.executetasknumtotal + "</td><td>" + zyTotal.executetasktotalrate + "</td><td>" + zyTotal.businesstypenumtotal + "</td><td>" + zyTotal.basecoverusertotal + "</td><td>" + zyTotal.residenttotalrate + "</td><td>" + zyTotal.sendusertotalnum + "</td><td>" + zyTotal.smstotalrate + "</td>";
                    ...
                    // 总合计
                    if (allTotal) {
                        var allTotalTdHtml = "<td></td><td></td><td></td><td></td><td>" + allTotal.provincetasknumtotal + "</td><td>" + allTotal.citytasknumtotal + "</td><td>" + allTotal.basetasknumtotal + "</td><td>" + allTotal.executetasknumtotal + "</td><td>" + allTotal.executetasktotalrate + "</td><td>" + allTotal.businesstypenumtotal + "</td><td>" + allTotal.basecoverusertotal + "</td><td>" + allTotal.residenttotalrate + "</td><td>" + allTotal.sendusertotalnum + "</td><td>" + allTotal.smstotalrate + "</td>";
    ...
    obj.evtOnQuery = function () {
        var params = "dateTime=" + $("#txtQueryDate").val() + "&areaCode=" + $("#selectQueryBaseAreas").val() + "&locationType=" + $("#selectQueryLocationType").val() + "&baseId=" + $("#selectQueryBase").val() + "&bussHallCoding=" + $.trim($("#bussHallCoding").val());
    ...
    obj.setEmptyHtml = function () {
        var tdHtml = "<td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0.00%</td><td>0</td><td>0</td><td>0.00%</td><td>0</td><td>0.00%</td>",
